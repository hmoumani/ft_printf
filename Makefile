...
#    Updated: 2020/01/21 22:43:20 by hmoumani         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_putchar_fd.c ft_flags.c\
	...
	ft_calloc.c ft_strrev.c\
	ft_strchr.c ft_abs.c\
	ft_itoa.c ft_putstr_fd.c ft_printp.c ft_prints.c \
	 ft_printu.c ft_printc.c ft_printd.c \
...
OBJ = ft_atoi.o ft_putchar_fd.o ft_flags.o\
	...
	ft_calloc.o ft_strrev.o\
	ft_strchr.o ft_abs.o\
	ft_itoa.o ft_putstr_fd.o ft_printp.o  ft_prints.o \
	ft_printu.o ft_printc.o ft_printd.o \
