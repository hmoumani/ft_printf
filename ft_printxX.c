...
/*   Updated: 2020/01/19 23:48:31 by hmoumani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_precx(int len, char *s)
{
	int		i;
	int		width;
...
int		ft_printd_x(int size, int num, char *s, int len)
{
	int i;
...
void	ft_width_x(char *s, int num)
{
	int		size;
	size_t	len;
